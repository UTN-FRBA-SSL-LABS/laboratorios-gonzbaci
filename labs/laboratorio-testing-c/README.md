...
> R:Porque en C las variables locales no se inicializan automáticamente. Si no llamás a carrito_init, c->cantidad podría arrancar con cualquier valor indeterminado en vez de 0, y entonces carrito_agregar empezaría a escribir productos en una posición equivocada del array items, o carrito_contar devolvería un número sin sentido.
...
> R:El test falla. Esperaba 700 (350 × 2) y obtuvo 350.
...
> R:Está en la linea 24 y dice total += c->items[i].precio; (solo suma el precio, ignorando la cantidad)
...
> R:El test falla. El 5to carrito_agregar en vez de 0 devuelve 1, es decir, éxito.
...
> R:El operador es <= y deberia ser < exclusivo.
